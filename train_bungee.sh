...
./train.sh -d bungeenerf/chicago -l ${exp_name} --lod 30 --gpu -1 --voxel_size ${voxel_size} --update_init_factor ${update_init_factor} --appearance_dim ${appearance_dim} --ratio ${ratio} &
sleep 20s
